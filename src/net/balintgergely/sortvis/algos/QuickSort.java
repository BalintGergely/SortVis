...
public class QuickSort extends ConfigurableSorter{
	...
	new AbstractSibling("Twin Left-Right",(VisualArray vis,Sorter srt, Executor exe) -> {
	...
	new AbstractSibling("Twin Left-Left",(VisualArray vis,Sorter srt, Executor exe) -> {
		final int pivot = vis.size-1;//Absolute
		pickPivot(vis, 0, vis.size, pivot);
		vis.setColor(pivot, 0xffffff00);
	...
	new AbstractSibling("Twin Right-Right",(VisualArray vis,Sorter srt, Executor exe) -> {
	...
	new AbstractSibling("Dual Left-Right",(VisualArray vis,Sorter srt, Executor exe) -> {
		...
		return combine(
				sortTask(vis.subArray(0, leftb),this,srt,exe),
				r == 0 ? COMPLETED_TASK : sortTask(vis.subArray(leftb+1,righta-leftb-2),this,srt,exe),
				sortTask(vis.subArray(righta, vis.size-righta),this,srt,exe),
				() -> {
					vis.setColor(afin, 0);
					vis.setColor(bfin, 0);
	...
	new AbstractSibling("Dual Left-Left",(VisualArray vis,Sorter srt, Executor exe) -> {
		final int pivota = 0,pivotb = vis.size-1;//Absolute
		pickPivot(vis, 0, vis.size, pivota);
		vis.setColor(pivota, 0xffffff00);
		pickPivot(vis, 1,vis.size-1, pivotb);
		...
		return combine(
				sortTask(vis.subArray(0, lefta),this,srt,exe),
				r == 0 ? COMPLETED_TASK : sortTask(vis.subArray(lefta+1, right-lefta-1),this,srt,exe),
	...
	new AbstractSibling("Dual Right-Right",(VisualArray vis,Sorter srt, Executor exe) -> {
		final int pivota = 0,pivotb = vis.size-1;//Absolute
		pickPivot(vis, 0, vis.size, pivota);
		vis.setColor(pivota, 0xffffff00);
		pickPivot(vis, 1, vis.size-1, pivotb);
		...
		return combine(
				sortTask(vis.subArray(rightb+1, vis.size-rightb-1),this,srt,exe),
				r == 0 ? COMPLETED_TASK : sortTask(vis.subArray(left+1, rightb-left-1),this,srt,exe),
				sortTask(vis.subArray(0, left),this,srt,exe),
				() -> {
					vis.setColor(afin, 0);
					vis.setColor(bfin, 0);
