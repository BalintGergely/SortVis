...
public class CompletionTask<E> implements Runnable,CompletionStage<E>,Consumer<Object>{
	public static final CompletionStage<?> COMPLETED_STAGE = new CompletionTask<>();
	...
	public static CompletionTask<Void> runAsynch(Runnable rn,Executor e){
	...
	public void accept(Object e){
		...
		if(x == 1){
			if(call instanceof Consumer){
				...
				call = ((Function<Object,E>)call).apply(e);
			}else{
				call = e;
			}
			Runnable rn = (Runnable)POST_RUN.getAndSet(this,this);
